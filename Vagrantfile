...
### AUTOGENERATED FOR PLATFORM centos
configure(config, 'centos_server', centos6, '1536', '192.168.41.2', 'server', 'setup_server 2.10.9', 81)
configure(config, 'centos_agent1', centos6, '256', '192.168.41.3', 'agent1', 'setup_agent 2.10.9', 0)
